...
class JsonViewerWidget extends StatefulWidget {
  ...
  JsonViewerWidget(this.jsonObj, {required this.notRoot});
        ...
        children: <Widget>[
          ex
              ? ((openFlag[entry.key] ?? false)
                  ...
                  : Icon(Icons.arrow_right, color: Colors.grey[700]))
              : const Icon(
                  Icons.arrow_right,
...
class JsonArrayViewerWidget extends StatefulWidget {
  ...
  JsonArrayViewerWidget(this.jsonArray, {required this.notRoot});
